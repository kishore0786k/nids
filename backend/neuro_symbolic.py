...
def apply_symbolic_rules(
    ...
    `predicted_probs` is the probability vector for the original sample and
    `adversarial_probs` is the vector for a perturbed/adversarial sample.
    Rule R3 compares these two explicit inputs; it does not use hidden globals.
    """
